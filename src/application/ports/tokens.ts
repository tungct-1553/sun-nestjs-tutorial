...
export const CREATE_ARTICLE_PORT = Symbol('CREATE_ARTICLE_PORT');
export const GET_ARTICLE_PORT = Symbol('GET_ARTICLE_PORT');
export const LIST_ARTICLES_PORT = Symbol('LIST_ARTICLES_PORT');
export const UPDATE_ARTICLE_PORT = Symbol('UPDATE_ARTICLE_PORT');
export const DELETE_ARTICLE_PORT = Symbol('DELETE_ARTICLE_PORT');
